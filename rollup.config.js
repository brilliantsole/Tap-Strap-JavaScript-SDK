...
const name = "TS";
const input = "src/TS.ts";

const defaultOutput = {
  sourcemap: true,
  sourcemapPathTransform: (relativeSourcePath, sourcemapPath) => {
    return relativeSourcePath.replace("../src/", "../tapstrap/");
  },
};
...
const builds = [
    ...
    output: [
      {
        ...defaultOutput,
        format: "esm",
        file: "build/tapstrap.module.js",
      },
    ],
    ...defaultBuild,
  },
  {
    input: "./build/dts/TS.d.ts",
    ...
    plugins: [
      ...
      copy({
        targets: [
          { src: "build/index.d.ts", dest: "build", rename: "tapstrap.module.d.ts" },
          { src: "build/index.d.ts", dest: "build", rename: "tapstrap.module.min.d.ts" },
        ],
      }),
    ],
    ...defaultBuild,
    ...
    output: [
      {
        ...defaultOutput,
        format: "esm",
        file: "build/tapstrap.node.module.js",
      },
    ],
    ...defaultBuild,
  },
  {
    ...
    plugins: [
      ...
      dts(),
      copy({
        targets: [{ src: "build/index.node.d.ts", dest: "build", rename: "tapstrap.node.module.d.ts" }],
      }),
    ],
    ...defaultBuild,
  },
    ...
    output: [
      {
        ...defaultOutput,
        format: "esm",
        file: "build/tapstrap.module.min.js",
      },
    ],
    ...defaultBuild,
  },
